...
Note: `rearrr` is still quite new and not all functions are properly tested yet.
...
orderings <- data.frame(
  ...
  "closest_to" = closest_to(vec, origin_fn = create_origin_fn(median)),
  "furthest_from" = furthest_from(vec, origin = 5),
...
```{r echo=FALSE, fig.align='center', fig.width=7.6, fig.height=8.9}
...
```{r echo=FALSE, fig.align='center', fig.width=7.6, fig.height=4.25}
