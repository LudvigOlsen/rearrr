...
test_that("testing split_range_outliers()", {
  xpectr::set_test_seed(42)
  ...
  # Generate expectations for 'split_range_outliers'
  # Tip: comment out the gxs_function() call
  # so it is easy to regenerate the tests
  xpectr::set_test_seed(42)
  # xpectr::gxs_function(
  #   fn = split_range_outliers,
  #   args_values = list(
  ...
  ## Testing 'split_range_outliers'                                           ####
  ## Initially generated by xpectr
  # Testing different combinations of argument values

  # Testing split_range_outliers(data = df, col = "x", ....
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- split_range_outliers(data = df, col = "x", .min = 0.2, .max = 0.8)
  # Testing class
  expect_equal(
    class(output_19148),
    "list",
  ...
  # Testing split_range_outliers(data = c(1, 2, 3), col ...
  # Changed from baseline: data = c(1, 2, 3)
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19370 <- xpectr::capture_side_effects(split_range_outliers(data = c(1, 2, 3), col = "x", .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_19370[['error']]),
  ...
  # Testing split_range_outliers(data = NULL, col = "x",...
  # Changed from baseline: data = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_12861 <- xpectr::capture_side_effects(split_range_outliers(data = NULL, col = "x", .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_12861[['error']]),
    xpectr::strip("1 assertions failed:\n * Variable 'data': Must be of type 'data.frame', not 'NULL'."),
    fixed = TRUE)
  ...
  # Testing split_range_outliers(data = df, col = c("x",...
  # Changed from baseline: col = c("x", "y")
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_18304 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = c("x", "y"), .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_18304[['error']]),
  ...
  # Testing split_range_outliers(data = df, col = "z", ....
  # Changed from baseline: col = "z"
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16417 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = "z", .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_16417[['error']]),
  ...
  # Testing split_range_outliers(data = df, col = NA, .m...
  # Changed from baseline: col = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = NA, .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_15190[['error']]),
  ...
  # Testing split_range_outliers(data = df, col = NULL, ...
  # Changed from baseline: col = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_17365 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = NULL, .min = 0.2, .max = 0.8), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- split_range_outliers(data = df, col = "x", .min = NULL, .max = 0.8)
  # Testing class
  expect_equal(
    class(output_11346),
    "list",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_16569 <- split_range_outliers(data = df, col = "x", .min = 0.4, .max = 0.8)
  # Testing class
  expect_equal(
    class(output_16569),
    "list",
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_17050 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = "x", .min = NA, .max = 0.8), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_17050[['error']]),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_14577 <- split_range_outliers(data = df, col = "x", .min = 0, .max = NULL)
  # Testing class
  expect_equal(
    class(output_14577),
    "list",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17191 <- split_range_outliers(data = df, col = "x", .min = NULL, .max = 1)
  # Testing class
  expect_equal(
    class(output_17191),
    "list",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19346 <- split_range_outliers(data = df, col = "x", .min = 0.2, .max = NULL)
  # Testing class
  expect_equal(
    class(output_19346),
    "list",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_12554 <- split_range_outliers(data = df, col = "x", .min = 0.2, .max = 0.6)
  # Testing class
  expect_equal(
    class(output_12554),
    "list",
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_14622 <- xpectr::capture_side_effects(split_range_outliers(data = df, col = "x", .min = 0.2, .max = NA), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_14622[['error']]),
  ...
  ## Finished testing 'split_range_outliers'                                  ####
  #
