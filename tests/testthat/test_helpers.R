...
test_that("to_unit_vector()", {
  # Set seed
  xpectr::set_test_seed(42)

  vec1 <- runif(10)
  vecNormed <- to_unit_vector(vec1)
  ...
  # Generate expectations for 'to_unit_vector'
  ...
  # Testing to_unit_vector(x = c(1, 1, 1))
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- to_unit_vector(x = c(1, 1, 1))
  # Testing class
  expect_equal(
    class(output_19148),
    "numeric",
  ...
  # Testing to_unit_vector(x = c(0, 0, 0))
  # Changed from baseline: x = c(0, 0, 0)
  xpectr::set_test_seed(42)
  # Assigning output
  output_19370 <- to_unit_vector(x = c(0, 0, 0))
  # Testing class
  expect_equal(
    class(output_19370),
    "numeric",
  ...
  # Testing to_unit_vector(x = 1)
  # Changed from baseline: x = 1
  xpectr::set_test_seed(42)
  # Assigning output
  output_12861 <- to_unit_vector(x = 1)
  # Testing class
  expect_equal(
    class(output_12861),
    "numeric",
  ...
  # Testing to_unit_vector(x = 0)
  # Changed from baseline: x = 0
  xpectr::set_test_seed(42)
  # Assigning output
  output_18304 <- to_unit_vector(x = 0)
  # Testing class
  expect_equal(
    class(output_18304),
    "numeric",
  ...
  # Testing to_unit_vector(x = "hej")
  # Changed from baseline: x = "hej"
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16417 <- xpectr::capture_side_effects(to_unit_vector(x = "hej"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing to_unit_vector(x = NA)
  # Changed from baseline: x = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(to_unit_vector(x = NA), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing to_unit_vector(x = NULL)
  # Changed from baseline: x = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_17365 <- xpectr::capture_side_effects(to_unit_vector(x = NULL), reset_seed = TRUE)
  expect_equal(
  ...
  ## Finished testing 'to_unit_vector'                                        ####
  #
