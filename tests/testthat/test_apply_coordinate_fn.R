...
test_that("fuzz testing apply_coordinate_fn()", {
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE)
  # Testing class
  expect_equal(
    class(output_19148),
    "numeric",
  ...
  # Testing apply_coordinate_fn(dim_vectors = dim_vecs2,...
  # Changed from baseline: dim_vectors = dim_vecs2
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19370 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = dim_vecs2, coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing apply_coordinate_fn(dim_vectors = as.data.fr...
  # Changed from baseline: dim_vectors = as.data...
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_12861 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = as.data.frame(dim_vecs), coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing apply_coordinate_fn(dim_vectors = c(1, 2, 3)...
  # Changed from baseline: dim_vectors = c(1, 2, 3)
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_18304 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = c(1, 2, 3), coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing apply_coordinate_fn(dim_vectors = NA, coordi...
  # Changed from baseline: dim_vectors = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16417 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = NA, coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing apply_coordinate_fn(dim_vectors = NULL, coor...
  # Changed from baseline: dim_vectors = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = NULL, coordinates = c(0, 1, 2), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17365 <- apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = c(5, 5, 5), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE)
  # Testing class
  expect_equal(
    class(output_17365),
    "numeric",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = c(0, 0, 0, 0), fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE)
  # Testing class
  expect_equal(
    class(output_11346),
    "numeric",
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_16569 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = NA, fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_17050 <- xpectr::capture_side_effects(apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = NULL, fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_17050[['error']]),
    xpectr::strip("1 assertions failed:\n * Variable 'coordinates': Must be of type 'numeric', not 'NULL'."),
    fixed = TRUE)
  expect_equal(
  ...
  ## Finished testing 'apply_coordinate_fn'                                   ####
  #
