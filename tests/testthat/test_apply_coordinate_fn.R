...
test_that("fuzz testing apply_coordinate_fn()", {
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- apply_coordinate_fn(dim_vectors = dim_vecs, coordinates = NULL, fn = centroid, num_dims = 3, coordinate_name = "leCoordinate", fn_name = "leFunction", dim_var_name = "dimVar", allow_len_one = FALSE)
  # Testing class
  expect_equal(
    class(output_19148),
    "numeric",
  ...
  expect_equal(
    sum(xpectr::element_lengths(output_19148)),
    3L)
  ## Finished testing 'apply_coordinate_fn(dim_vectors = dim_vecs, ...'     ####
