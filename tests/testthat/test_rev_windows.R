...
test_that("fuzz testing rev_windows()", {
  ...
  #     "keep_windows" = list(FALSE, TRUE, NA),
  #     "factor_name" = list(".window", NA, 1)
  #   ),
  ...
  # Testing rev_windows(data = df, window_size = 3, keep...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- rev_windows(data = df, window_size = 3, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_19148),
    "data.frame",
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19370 <- rev_windows(data = dplyr::group_by(df, G), window_size = 3, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_19370),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_12861 <- rev_windows(data = 1:10, window_size = 3, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_12861),
    "integer",
  ...
  # Testing rev_windows(data = -3:3, window_size = 3, ke...
  # Changed from baseline: data = -3:3
  xpectr::set_test_seed(42)
  # Assigning output
  output_18304 <- rev_windows(data = -3:3, window_size = 3, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_18304),
    "integer",
  ...
  # Testing rev_windows(data = NA, window_size = 3, keep...
  # Changed from baseline: data = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16417 <- xpectr::capture_side_effects(rev_windows(data = NA, window_size = 3, keep_windows = FALSE, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rev_windows(data = NULL, window_size = 3, ke...
  # Changed from baseline: data = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(rev_windows(data = NULL, window_size = 3, keep_windows = FALSE, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17365 <- rev_windows(data = dplyr::group_by(df, G), window_size = 4, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_17365),
    c("grouped_df", "tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- rev_windows(data = df, window_size = 2, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_11346),
    "data.frame",
  ...
  # Testing rev_windows(data = df, window_size = 0, keep...
  # Changed from baseline: window_size = 0
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16569 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 0, keep_windows = FALSE, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rev_windows(data = df, window_size = 13, kee...
  # Changed from baseline: window_size = 13
  xpectr::set_test_seed(42)
  # Assigning output
  output_17050 <- rev_windows(data = df, window_size = 13, keep_windows = FALSE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_17050),
    "data.frame",
  ...
  # Testing rev_windows(data = df, window_size = NA, kee...
  # Changed from baseline: window_size = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_14577 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = NA, keep_windows = FALSE, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rev_windows(data = df, window_size = NULL, k...
  # Changed from baseline: window_size = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_17191 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = NULL, keep_windows = FALSE, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rev_windows(data = df, window_size = 3, keep...
  # Changed from baseline: keep_windows = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19346 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 3, keep_windows = NA, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_19346[['error']]),
    xpectr::strip("1 assertions failed:\n * Variable 'keep_windows': May not be NA."),
    fixed = TRUE)
  expect_equal(
  ...
  # Testing rev_windows(data = df, window_size = 3, keep...
  # Changed from baseline: keep_windows = TRUE
  xpectr::set_test_seed(42)
  # Assigning output
  output_12554 <- rev_windows(data = df, window_size = 3, keep_windows = TRUE, factor_name = ".window")
  # Testing class
  expect_equal(
    class(output_12554),
    "data.frame",
  ...
  # Testing rev_windows(data = df, window_size = 3, keep...
  # Changed from baseline: keep_windows = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_14622 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 3, keep_windows = NULL, factor_name = ".window"), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_14622[['error']]),
    xpectr::strip("1 assertions failed:\n * Variable 'keep_windows': Must be of type 'logical flag', not 'NULL'."),
    fixed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19400 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 3, keep_windows = FALSE, factor_name = NA), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19782 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 3, keep_windows = FALSE, factor_name = 1), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_11174 <- xpectr::capture_side_effects(rev_windows(data = df, window_size = 3, keep_windows = FALSE, factor_name = NULL), reset_seed = TRUE)
  expect_equal(
