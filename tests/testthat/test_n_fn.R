...
test_that("testing quantile_index()", {
  ...
  # For some reason the actual error on dev is:
  # "In index 1Caused by error in quantiledefault type must be an integer in 19"
  # But it is unclear what that is and why it fails here only (where type=10 is supposed to be the error)
  testthat::skip_on_cran()
  ## Testing 'quantile_index(x, y, z, prob = 0.6, type = 10)'               ####
  ## Initially generated by xpectr
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
