...
test_that("fuzz testing rotate_2d()", {
  ...
  # Testing rotate_2d(data = df, degrees = 10, x_col = "x...
  xpectr::set_test_seed(42)
  # Assigning output
  ...
  # Testing rotate_2d(data = dplyr::group_by(df, g), degr...
  ...
  # Testing rotate_2d(data = NA, degrees = 10, x_col = "x...
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17365 <- rotate_2d(data = dplyr::group_by(df, g), degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degrees_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_17365),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- rotate_2d(data = c(1, 2, 3, 4, 5), degrees = 10, x_col = NULL, y_col = NULL, suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degrees_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_11346),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_16569 <- xpectr::capture_side_effects(rotate_2d(data = c(1, 2, 3, 4, 5), degrees = 10, x_col = "x", y_col = NULL, suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degrees_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate_2d(data = df, degrees = NA, x_col = "x...
  ...
  # Testing rotate_2d(data = df, degrees = c(45, -45), x_...
  ...
  # Testing rotate_2d(data = df, degrees = 10, x_col = "y...
  ...
  # Testing rotate_2d(data = df, degrees = 10, x_col = NU...
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_14469 <- rotate_2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degrees_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_14469),
    c("tbl_df", "tbl", "data.frame"),
