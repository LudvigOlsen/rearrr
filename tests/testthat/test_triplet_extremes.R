...
test_that("fuzz testing triplet_extremes()", {
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_19148),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19370 <- triplet_extremes(data = head(dfs, 13), col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_19370),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_12861 <- triplet_extremes(data = head(dfs, 12), col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_12861),
    c("tbl_df", "tbl", "data.frame"),
  ...
  side_effects_18304 <- xpectr::capture_side_effects(triplet_extremes(data = dfs$index, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_16417 <- triplet_extremes(data = dplyr::group_by(dfs, G), col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_16417),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(triplet_extremes(data = NULL, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17365 <- triplet_extremes(data = head(df, 13), col = "C", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_17365),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- triplet_extremes(data = df, col = "B", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_11346),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_16569 <- triplet_extremes(data = head(dfs, 13), col = "A", middle_is = "middle", unequal_method_1 = "min", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_16569),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17050 <- triplet_extremes(data = head(dfs, 13), col = "A", middle_is = "middle", unequal_method_1 = "max", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_17050),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_14577 <- triplet_extremes(data = dfs, col = "index", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_14577),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_17191 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "NOPE", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19346 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = NA, middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_12554 <- triplet_extremes(data = dfs, col = NULL, middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_12554),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing column values
  expect_equal(
    output_12554[["index"]], # Index is reordered when col==NULL
    c(7, 8, 1, 6, 14, 2, 9, 13, 3, 5, 12, 4, 10, 11),
    tolerance = 1e-4)
  expect_equal(
    output_12554[["G"]],
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_14622 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "hjsdf", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19400 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = NA, unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19782 <- triplet_extremes(data = dfs, col = "A", middle_is = "min", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_19782),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11174 <- triplet_extremes(data = dfs, col = "A", middle_is = "max", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_11174),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_14749 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = NULL, unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_15603 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "hjsdf", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19040 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = min, unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_11387 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = NA, unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19888 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = NULL, unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19466 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("min", "max"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_19466),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_10824 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("min", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_10824),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_15142 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = "max", num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing triplet_extremes(data = dfs, col = "A", midd...
  # Changed from baseline: unequal_method_2 = "f...
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_13902 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = "fdsf", num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing triplet_extremes(data = dfs, col = "A", midd...
  # Changed from baseline: unequal_method_2 = min
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19057 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = min, num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
    xpectr::strip(side_effects_19057[['error']]),
    xpectr::strip("1 assertions failed:\n * Variable 'unequal_method_2': Must be of type 'character', not 'builtin'."),
    fixed = TRUE)
  expect_equal(
  ...
  # Testing triplet_extremes(data = dfs, col = "A", midd...
  # Changed from baseline: unequal_method_2 = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_14469 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = NA, num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_18360 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = NULL, num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_18110 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = NULL, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_13881 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 2, balance = "spread", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_13881),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_16851 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 2, balance = "min", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_16851),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_10039 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 2, balance = "max", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_10039),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_18329 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = 2, shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_10073 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = NA, shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_12076 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = NULL, shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19066 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = TRUE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_19066),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_16117 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = NA, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_13795 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = NULL, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_14357 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = TRUE, shuffle_triplets = TRUE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_14357),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_10374 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = TRUE, factor_name = ".trip", overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_10374),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19735 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = NA, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_14317 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = NULL, factor_name = ".trip", overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19575 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = 2, overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_18877 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = NA, overwrite = FALSE), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_16399 <- triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = NULL, overwrite = FALSE)
  # Testing class
  expect_equal(
    class(output_16399),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19709 <- xpectr::capture_side_effects(triplet_extremes(data = dfs, col = "A", middle_is = "middle", unequal_method_1 = "middle", unequal_method_2 = c("middle", "middle"), num_groupings = 1, balance = "mean", shuffle_members = FALSE, shuffle_triplets = FALSE, factor_name = ".trip", overwrite = NULL), reset_seed = TRUE)
  expect_equal(
