...
test_that("fuzz testing rotate2d()", {
  ...
  # Testing rotate2d(data = df, degrees = 10, x_col = "x...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19148 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_19148),
  ...
  # Testing rotate2d(data = dplyr::group_by(df, g), degr...
  # Changed from baseline: data = dplyr::group_b...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19370 <- rotate2d(data = dplyr::group_by(df, g), degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_19370),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing rotate2d(data = "hej", degrees = 10, x_col =...
  ...
  # Testing rotate2d(data = NA, degrees = 10, x_col = "x...
  # Changed from baseline: data = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_16417 <- xpectr::capture_side_effects(rotate2d(data = NA, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = NULL, degrees = 10, x_col = ...
  # Changed from baseline: data = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_15190 <- xpectr::capture_side_effects(rotate2d(data = NULL, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_17365 <- rotate2d(data = dplyr::group_by(df, g), degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_17365),
    c("tbl_df", "tbl", "data.frame"),
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_11346 <- rotate2d(data = c(1, 2, 3, 4, 5), degrees = 10, x_col = NULL, y_col = NULL, suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_11346),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing rotate2d(data = df, degrees = NA, x_col = "x...
  # Changed from baseline: degrees = NA
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_17050 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = NA, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = -10, x_col = "...
  # Changed from baseline: degrees = -10
  xpectr::set_test_seed(42)
  # Assigning output
  output_14577 <- rotate2d(data = df, degrees = -10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_14577),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing rotate2d(data = df, degrees = 400, x_col = "...
  # Changed from baseline: degrees = 400
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_17191 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 400, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19346 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = -400, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = c(45, -45), x_...
  # Changed from baseline: degrees = c(45, -45)
  xpectr::set_test_seed(42)
  # Assigning output
  output_12554 <- rotate2d(data = df, degrees = c(45, -45), x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_12554),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing rotate2d(data = df, degrees = "hej", x_col =...
  # Changed from baseline: degrees = "hej"
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_14622 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = "hej", x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = NULL, x_col = ...
  # Changed from baseline: degrees = NULL
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19400 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = NULL, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = 10, x_col = "y...
  # Changed from baseline: x_col = "y"
  xpectr::set_test_seed(42)
  # Testing side effects
  # Assigning side effects
  side_effects_19782 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "y", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = 10, x_col = NU...
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_14749 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "x", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19040 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "_rotated", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_19040),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_11387 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = NULL, origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19888 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "_rotated", origin = c(0, 0), origin_fn = NULL, keep_original = TRUE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_19888),
    c("tbl_df", "tbl", "data.frame"),
  ...
  expect_equal(
    names(output_19888),
    c("x", "y", "z", "g", "x_rotated", "y_rotated", ".degrees"),
    fixed = TRUE)
  # Testing column classes
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_19466 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0.3, -0.3), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_19466),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_10824 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = 0, origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_15142 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = "h", origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_13902 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(NA, 1), origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_19057 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = NULL, origin_fn = NULL, keep_original = FALSE, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  xpectr::set_test_seed(42)
  # Assigning output
  output_14469 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = centroid, keep_original = FALSE, degree_col_name = ".degrees")
  # Testing class
  expect_equal(
    class(output_14469),
    c("tbl_df", "tbl", "data.frame"),
  ...
  # Testing side effects
  # Assigning side effects
  side_effects_18360 <- xpectr::capture_side_effects(rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = NULL, degree_col_name = ".degrees"), reset_seed = TRUE)
  expect_equal(
  ...
  # Testing rotate2d(data = df, degrees = 10, x_col = "x...
  # Changed from baseline: degree_col_name = NULL
  xpectr::set_test_seed(42)
  # Assigning output
  output_17375 <- rotate2d(data = df, degrees = 10, x_col = "x", y_col = "y", suffix = "", origin = c(0, 0), origin_fn = NULL, keep_original = FALSE, degree_col_name = NULL)
  # Testing class
  expect_equal(
    class(output_17375),
    c("tbl_df", "tbl", "data.frame"),
...
test_that("degree pairs make same rotations with rotate2d()", {
  xpectr::set_test_seed(42)
  ...
  test_degree_pair <- function(deg1, deg2){
    out1 <- rotate2d(data = df, degrees = deg1, x_col = "x", y_col = "y", suffix = "", origin = c(0.5, 0.5), keep_original = FALSE, degree_col_name = NULL)
    out2 <- rotate2d(data = df, degrees = deg2, x_col = "x", y_col = "y", suffix = "", origin = c(0.5, 0.5), keep_original = FALSE, degree_col_name = NULL)
